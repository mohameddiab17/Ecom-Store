...
function handleNavbar() {
  ...
  const logoutDesktopBtn = document.getElementById("logoutBtn");
  ...
  if (loggedInUser) {
    ...
    if (logoutDesktopBtn) logoutDesktopBtn.addEventListener("click", logoutAction);
    ...
    if (mobileUserLinks) mobileUserLinks.style.visibility = "hidden", mobileUserLinks.style.height = "10px";
