...
function initializeProducts() {
    ...
    const initialProducts = [
        new Product(1, "Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops", "Your perfect pack for everyday use and walks in the forest...", 109.95, 3.9, 120, "men's clothing", "https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_t.png", true),
        new Product(2, "Mens Casual Premium Slim Fit T-Shirts", "Slim-fitting style, contrast raglan long sleeve...", 22.3, 4.1, 259, "men's clothing", "https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_t.png", false),
        new Product(3, "Mens Cotton Jacket", "great outerwear jackets for Spring/Autumn/Winter...", 55.99, 4.7, 500, "men's clothing", "https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_t.png", true),
        new Product(4, "Mens Casual Slim Fit", "The color could be slightly different between on the screen and in practice...", 15.99, 2.1, 430, "men's clothing", "https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_t.png", false),
        new Product(5, "John Hardy Women's Legends Naga Gold & Silver Bracelet", "From our Legends Collection, the Naga was inspired by the mythical water dragon...", 695, 4.6, 400, "jewelery", "https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_t.png", true),
        new Product(6, "Solid Gold Petite Micropave", "Satisfaction Guaranteed. Return or exchange any order within 30 days.", 168, 3.9, 70, "jewelery", "https://fakestoreapi.com/img/61sbMiUnoGL._AC_UL640_QL65_ML3_t.png", false),
        ...
        new Product(14, "Samsung 49-Inch CHG90 144Hz Curved Gaming Monitor", "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR.", 999.99, 2.2, 140, "electronics", "https://fakestoreapi.com/img/81Zt42ioCgL._AC_SX679_t.png", false),
        new Product(15, "BIYLACLESEN Women's 3-in-1 Snowboard Jacket", "Note:The Jackets is US standard size, Please choose size as your usual wear.", 56.99, 2.6, 235, "women's clothing", "https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_t.png", false),
        new Product(16, "Lock and Love Women's Removable Hooded Faux Leather Jacket", "100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER).", 29.95, 2.9, 340, "women's clothing", "https://fakestoreapi.com/img/81XH0e8fefL._AC_UY879_t.png", false),
        new Product(18, "MBJ Women's Solid Short Sleeve Boat Neck V", "95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach.", 9.85, 4.7, 130, "women's clothing", "https://fakestoreapi.com/img/71z3kpMAYsL._AC_UY879_t.png", false),
        new Product(19, "Opna Women's Short Sleeve Moisture", "100% Polyester, Machine wash, 100% cationic polyester interlock.", 7.95, 4.5, 146, "women's clothing", "https://fakestoreapi.com/img/51eg55uWmdL._AC_UX679_t.png", false),
...
function handleNavbar() {
    ...
    const joinSellerBtn = document.getElementById("join-seller-btn");
    ...
    if (loggedInUser) {
        ...
        if (user.accountType && user.accountType.toLowerCase() === "admin") {
            if (!document.querySelector('.nav-links a[href="/admin/admin.html"]')) {
                ...
                navLinksContainers.forEach(container => container.insertAdjacentHTML('afterbegin', adminDashboardLink));
            }
            if (joinSellerBtn) joinSellerBtn.style.display = 'none';
        } else if (user.accountType && user.accountType.toLowerCase() === "seller") {
            if (!document.querySelector('.nav-links a[href="/seller/seller.html"]')) {
                ...
                navLinksContainers.forEach(container => container.insertAdjacentHTML('afterbegin', sellerDashboardLink));
            }
            if (joinSellerBtn) joinSellerBtn.style.display = 'none';
        }
        ...
        if (joinSellerBtn) joinSellerBtn.style.display = 'inline-block';
    }
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const allProducts = loadProducts(); // <-- بنجيب المنتجات من localStorage
    const featuredProducts = allProducts.filter(p => p.featured === true); // <-- بنفلتر عشان نجيب المميزة بس
    
    renderProducts(featuredProducts); // <-- بنعرض المنتجات المميزة
});
