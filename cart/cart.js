document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderCart() {
            ...
            const cartItemHTML = `
                <div class="cart-item" data-product-id="${item.id}">
                    <div class="d-flex align-items-center">
                        <img src="${item.image}" class="rounded me-3" alt="${item.name}">
                        <div class="ms-3">
                    ...
                    <div class="text-end">
                        ...
                        <p class="text-muted small">Total: $${itemTotal.toFixed(2)}</p>
        ...
        document.getElementById("cart-items-count").textContent = `${totalItems} item(s) in your cart`;
