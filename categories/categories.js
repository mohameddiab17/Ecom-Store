document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderCategories() {
        ...
        categories.forEach(category => {
            const iconClass = categoryIcons[category.toLowerCase()] || categoryIcons["default"];
            // Create a link to the products page with a category filter
            const categoryLink = `../products/products.html?category=${encodeURIComponent(category)}`;
